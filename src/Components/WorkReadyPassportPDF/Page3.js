...
return (
    ...
    <div>
       ...
       <img src={CornerLogo} width='200px' height='200px'/>
            ...
            <Grid item xs={12}>
    <h2> Congratulations for choosing to strive for the Work Ready Passport, {props.userInformation.fullName} { /* get full name prop from WorkReadyPassportHandler */}</h2>
        <p>
