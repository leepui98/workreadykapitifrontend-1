...
const HandleChange= value =>{
    ...
    return(
      ...
      <Pagination count={5} onClickCapture={HandleChange} defaultCurrent={5} defaultPageSize={cardEachPage} total={5}/>
          
        {mockData && mockData.length>0 && mockData.slice(page.minValue,page.maxValue).map(data => {
          return(<JobPost jobdata={data} />)
      })}  
      <Pagination onChange={HandleChange} defaultCurrent={5} defaultPageSize={cardEachPage} total={5}/>
    </div>
