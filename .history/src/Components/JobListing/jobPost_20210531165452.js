...
import MessageApply from './applyMessage'
...
//    {mockData.map((data)=>{
    return (
        ...
        <Card className="mb-3">
            ...
            <div >
            <a href="/employerprofile"><img className="d-none d-md-block" height="50" width="80"alt={props.jobdata.companyname} src={props.jobdata.logo} style={{marginLeft:"50px"}}/></a>
            </div>
            </div>
            <div>
