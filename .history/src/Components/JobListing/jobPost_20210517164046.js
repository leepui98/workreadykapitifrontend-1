...
//    {mockData.map((data)=>{
    return (
        ...
        <Card className="mb-3">
            ...
            <Card.Title>
              {props.jobdata.jobtitle} - <span className="text-muted font-weight-light"><a href="">{props.jobdata.companyname}</a></span>
              
            </Card.Title>
            <div >
            <img className="d-none d-md-block" height="60" alt={props.jobdata.companyname} src={props.jobdata.logo} style={{marginLeft:"50px"}}/>
            </div>
            </div>
            <div>
            <Badge variant="secondary" className="mr-2 mb-1">{props.jobdata.jobhours}</Badge>
            <Badge variant="secondary" className="mr-2 mb-1">{props.jobdata.jobpay}</Badge>
            <Badge variant="secondary" className="mr-2 mb-1">{props.jobdata.startdate}</Badge>
          </div>
          <div className="text-muted d-none d-md-block mb-1">
