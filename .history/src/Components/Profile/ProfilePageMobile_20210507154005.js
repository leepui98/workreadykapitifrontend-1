...
export default function ProfilePageMobile(){
    ...
    return(
            ...
            <div class="d-flex justify-content-center align-items-center" className="infoBlockMobile" style={{width:"120%", marginLeft:"5px", paddingRight:"10px",paddingLeft:"60px"}}>
            <Col>
