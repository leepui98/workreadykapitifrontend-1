...
export default function ProfilePageDesktop (){
        ...
        return(
            ...
            <ProfilePicture/>
            <div class="d-flex justify-content-center align-items-center" className="infoBlockDesktop" style={{marginTop:"25px", width:"100%", paddingLeft:"180px", marginLeft:"20px"}}>
            <Infoblock/>
            </div>
            </div>
