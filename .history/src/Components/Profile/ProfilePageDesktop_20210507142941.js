...
export default function ProfilePageDesktop (){
        ...
        return(
            ...
            <div class="d-flex justify-content-center align-items-center col-xs-6" className="infoBlockDesktop" style={{marginTop:"0px", width:"80%", paddingLeft:"15px", marginLeft:"0px"}}>
