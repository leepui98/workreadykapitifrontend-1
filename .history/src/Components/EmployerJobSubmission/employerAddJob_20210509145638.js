    ...
    return (
        <div>
            <Form style={{marginTop:"40px"}}>
                ...
                <Col sm={6}>
                    <Form.Control class="form-control input-lg" id="inputlg" type="businessName" id="inputToStyle"/>
                </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} controlId="formHorizontalWhatWeDo" style={{marginBottom:"30px"}}>
                    ...
                    <Col sm={2}>
                        <Form.Control type="whatWeDo" id="inputToStyle"/>
                    </Col>
                    </Form.Group> 
                    ...
                    <Col sm={2}>
                        <Form.Control type="roleOutline" id="inputToStyle"/>
                    </Col>
                    </Form.Group>
                    ...
                    <Col sm={2}>
                        <Form.Control type="keyTasks" id="inputToStyle"/>
                    </Col>
                    </Form.Group>
