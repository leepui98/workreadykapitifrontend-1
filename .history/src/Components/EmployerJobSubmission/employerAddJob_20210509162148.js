        ...
        <div>
            <Form style={{marginTop:"40px"}}>
                ...
                <Form.Group as={Row} controlId="formHorizontalWhatWeDo" style={{marginBottom:"30px"}}>
                    ...
                    <Col  >
                    <Form.Label column sm={10} style={{color:"black"}}>
                       Photos of you allowed on website and social media
                    </Form.Label>
                    </Col>
                    <Col sm={2} >
                
                        <Form.Check type="radio" label="yes" name="formHorizontalPhotoConsent" id="formHorizontalPhotoConsentYes" style={{color:"black"}}/>
                        <Form.Check type="radio" label="no" name="formHorizontalPhotoConsent" id="formHorizontalPhotoConsentNo" style={{color:"black"}} />
