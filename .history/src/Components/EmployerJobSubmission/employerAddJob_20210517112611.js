...
export default function EmployerForm() {
   ...
   function showHidemyText(){
    <Form.Control type="testing" id="inputToStyle1" className="text-center text-md-left" placeholder="$?"/>
}
