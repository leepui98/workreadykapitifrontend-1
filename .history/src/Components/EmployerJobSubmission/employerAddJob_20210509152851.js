    ...
    return (
        <div>
            <Form style={{marginTop:"40px"}}>
                ...
                <Col sm={6} >
                    <Form.Control type="businessName" id="inputToStyle" className="text-center text-md-right" />
                </Col>
                </Form.Group>
                <Form.Group as={Row} controlId="formHorizontalContactPerson" style={{marginBottom:"30px"}}>
                    ...
                    <Col sm={6}>
                        <Form.Control type="contactPerson" id="inputToStyle"/>
                    </Col>
                    </Form.Group> 
                <Form.Group as={Row} controlId="formHorizontalWebsite" style={{marginBottom:"30px"}}>
                    ...
                    <Col sm={6}>
                        <Form.Control type="website" id="inputToStyle"/>
                    </Col>
                    </Form.Group> 
                <Form.Group as={Row} controlId="formHorizontalWhatWeDo" style={{marginBottom:"30px"}}>
                    ...
                    <Col sm={6} >
                        <Form.Control as="textarea" rows={3} type="whatWeDo" id="inputToStyle"/>
                    </Col>
                    </Form.Group> 
                    ...
                    <Col sm={6}>
                        <Form.Control as="textarea" rows={3} type="roleOutline" id="inputToStyle"/>
                    </Col>
                    </Form.Group>
                    ...
                    <Col sm={6}>
                        <Form.Control as="textarea" rows={3} type="keyTasks" id="inputToStyle"/>
                    </Col>
                    </Form.Group>
                    ...
                    <Col sm={6}>
                        <Form.Control type="idealStartEndData" id="inputToStyle"/>
                    </Col>
                    </Form.Group>
                    ...
                    <Col sm={6}>
                        <Form.Control type="hoursRequired" id="inputToStyle"/>
                    </Col>
                    </Form.Group>
