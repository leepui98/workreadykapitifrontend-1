        ...
        <div>
            ...
            <Form style={{marginTop:"40px"}}>
                ...
                <Form.Group as={Row} controlId="formHorizontalWebsite" style={{marginBottom:"30px"}}>
                    ...
                    <Form.Group as={Row} controlId="formHorizontalLogo" style={{marginBottom:"30px"}}>
                    <Form.Label column sm={3} className="labelStyle">
                        Logo
                    </Form.Label>
                    <Col sm={6}>
                ...
                <Form.Group as={Row} controlId="formHorizontalWhatWeDo" style={{marginBottom:"30px"}}>
                   ...
                   <Col sm={3}>
                    ...
                    <Col >
                    <Form.Label class="col1"column sm={10} row sm={10}style={{color:"black", marginLeft:"1px", size:"1px 1px", paddingLeft:"1px", paddingRight:"1px"}} >
