            ...
            <Form style={{marginTop:"40px"}}>
                ...
                <Form.Group as={Row} controlId="formHorizontalWhatWeDo" style={{marginBottom:"30px"}}>
                   ...
                   <Col sm={3} style={{marginLeft:"110px"}}>
                    ...
                    <Col >
                    <Form.Label column sm={9} row sm={9}style={{color:"black", marginLeft:"20px", size:"1px 1px", paddingLeft:"1px", paddingRight:"1px"}} >
                       Photos of you allowed on website and social media
                    </Form.Label>
                    </Col>
                    <Col sm={3} style={{paddingLeft:"0px", paddingRight:"0px" , marginRight:"80px"}} >
